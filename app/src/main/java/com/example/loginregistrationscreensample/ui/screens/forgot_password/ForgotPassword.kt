package com.example.loginregistrationscreensample.ui.screens.forgot_password
...
fun ScaffoldWithTopBarForgotPass(navController: NavHostController) {
    Scaffold(
        topBar = {
            CustomTopAppBar(navController, stringResource(R.string.top_app_bar_forgot_password), true)
            ...
            Column(
                ...
                Text(
                    text = stringResource(R.string.place_holder_forgot_password),
                    fontSize = 30.sp,
